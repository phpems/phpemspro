					...
					<div class="panel-body">
						<form action="index.php?lesson-master-lessons-add" method="post" class="form-horizontal">
							<div class="form-group">
								...
								<div class="col-sm-9">
									<select name="args[lessoncatid]" refUrl="index.php?-master-ajax-getchildcategory&catid={value}" class="autocombox form-control col-xs-3" style="width:20%" needle="needle" msg="请选择分类" id="lessoncatid">
							...
							<div class="form-group">
								<label class="control-label col-sm-2">做为免费课程</label>
								<div class="col-sm-9">
									...
									<span class="help-block">免费课程用户开通时不收费</span>
								</div>
							</div>
							<div class="form-group">
