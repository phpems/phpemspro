                ...
                <div class="page-form">
                    <form method="post" action="index.php?user-mobile-login-register">
                        <div class="form-group border">
                            ...
                            <div class="col-xs-9">
                                <input type="text" class="form-control" name="args[username]" needle="needle" datatype="userName" msg="您必须填写用户名" placeholder="请输入用户名"/>
                            </div>
                        </div>
                        <div class="form-group border">
                            <label class="control-label col-xs-3">邮箱</label>
                            <div class="col-xs-9">
                                <input type="text" class="form-control" name="args[useremail]" needle="needle" datatype="email" msg="您必须填写邮箱" placeholder="请输入邮箱"/>
                            </div>
                        </div>
                        <div class="form-group border">
                            <label class="control-label col-xs-3">手机号码</label>
                            <div class="col-xs-9">
                                <input type="text" class="form-control" id="regphonenumber" name="args[userphone]" needle="needle" datatype="phonenumber" msg="您必须填写手机号" placeholder="请输入手机号"/>
                            </div>
                        </div>
                        <div class="form-group border">
                        ...
                        <div class="form-group border">
                            ...
                            <div class="col-xs-9">
                                <input type="password" class="form-control" name="args[userpassword]" needle="needle" datatype="password" msg="您必须填写登陆密码" placeholder="请输入登陆密码"/>
                            </div>
                        </div>
