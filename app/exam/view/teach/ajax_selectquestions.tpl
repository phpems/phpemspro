...
<form action="index.php?exam-teach-ajax-selectquestions" method="post" direct="modal-body">
	<table class="table form-inline">
		...
		<tr>
			<td>
				知识点：<select style="width: 8rem;" name="search[questionsectionid]" class="combox form-control" id="sectionselect" target="knowsselect" refUrl="index.php?exam-teach-ajax-getpointsbysectionid&sectionid={value}">
