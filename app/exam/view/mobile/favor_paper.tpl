			...
			<div class="pages-content" data-refresh="yes">
				<div class="swiper-container">
					...
					<div class="swiper-wrapper">
						...
						<div class="pages-box swiper-slide" data-questionid="{x2;v:question['questionid']}" {x2;if:$questypes[v:question['questiontype']]['questsort']}data-sort="1" data-answer="A"{x2;else}data-sort="0" data-answer="{x2;v:question['questionanswer']}"{x2;endif} data-favor="1">
		...
		<script>
			$(function() {
                ...
                if(pep.isTrueVar($('#lastquestion').val())) {
                    mySwiper.slideTo($('#lastquestion').val(), 0);
                }
			});
		</script>
    {x2;if:!$_userhash}
