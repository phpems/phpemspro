...
<form action="index.php?exam-master-ajax-selectquestions" method="post" direct="modal-body">
	<table class="table form-inline">
		...
		<tr>
			<td>
				知识点：<select style="width: 8rem;" name="search[questionsectionid]" class="combox form-control" id="sectionselect" target="knowsselect" refUrl="index.php?exam-master-ajax-getpointsbysectionid&sectionid={value}">
			...
			<td>
				<select name="search[questionpointid]" id="knowsselect" class="form-control" style="width: 8rem;">
					<option value="">选择知识点</option>
                    {x2;if:$points[$search['questionsectionid']]}
