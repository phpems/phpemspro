...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.mathJaxLib = 'public/static/js/ckeditor/js/MathJax.js?config=TeX-AMS_HTML';
	config.line_height = "1;1.5;2;2.5;3;4;";

	// Simplify the dialog windows.
	config.removeDialogTabs = 'image:advanced;link:advanced';
	CKEDITOR.config.contentsCss = ['public/static/css/bootstrap.css','public/static/css/jquery-ui.min.css','public/static/css/peskin.css','public/static/js/ckeditor/ckeditor.css'];
};
